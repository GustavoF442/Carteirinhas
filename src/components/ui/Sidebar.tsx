            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-gradient-to-r from-[#1a2744] to-[#2d1a3e] text-white shadow-sm'
        ...
        <nav className="flex items-center justify-around px-2 py-1">
          {items.slice(0, 5).map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  'flex flex-col items-center gap-0.5 px-2 py-2 rounded-lg text-[10px] font-medium transition-colors min-w-0 flex-1',
                  isActive
                    ? 'text-[#1a2744]'
                    : 'text-gray-400'
                )}
              >
                <span className={isActive ? 'text-[#1a2744]' : 'text-gray-400'}>
                  {iconMap[item.icon] || iconMap.dashboard}
                </span>
          ...
          {items.length > 5 && (
            <button
              ...
              className="flex flex-col items-center gap-0.5 px-2 py-2 rounded-lg text-[10px] font-medium text-gray-400 min-w-0 flex-1"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
